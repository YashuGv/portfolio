  ...
  const skillCategories = [
    {
      ...
      title: "Languages",
      skills: ["C#", "SQL", "JavaScript", "TypeScript", "HTML", "CSS"],
    },
    {
      icon: <Server className="h-6 w-6" />,
      title: "Technologies / Tools",
      skills: [".NET / ASP.NET Core", "Entity Framework Core & ADO.NET ", "Angular", "Docker & Git", "Azure / IIS"],
    },
    {
      icon: <Palette className="h-6 w-6" />,
      title: "Skills",
      skills: ["Front-end development", "API development", "Testing & debugging",        "Database design & management", "Cloud deployment (Azure, IIS)"],
    },
    {
      icon: <Brain className="h-6 w-6" />,
      title: "Soft Skills",
      skills: ["Collaboration", "Problem-solving", "Adaptability", "Communication", "Time management"],
    },
  ]
