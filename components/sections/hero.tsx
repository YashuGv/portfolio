      ...
      >
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-teal-200 drop-shadow-[0_0_15px_rgba(45,212,191,0.5)]">
            Venkata Yasaswini Godavarthi
          </span>
        </h1>
        <p className="text-xl md:text-2xl text-gray-400 font-light">Software Engineer || .NET Full Stack Developer</p>
        <div className="pt-4 flex flex-wrap gap-4 justify-center">
          <a
            href="/files/Yasaswini_SoftwareEngineer_CV.pdf"  
            download="Yasaswini_SoftwareEngineer_CV.pdf"  
          ...
          <a
            href="https://www.linkedin.com/in/venkata-yasaswini-godavarthi-4030731a0"
            target="_blank"
