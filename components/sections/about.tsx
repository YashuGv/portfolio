  ...
  const quickFacts = [
    {
      ...
      description: ".NET Full Stack Developer (U.S. Healthcare Domain)",
    },
    {
      icon: <Briefcase className="h-5 w-5 text-teal-400" />,
      title: "Experience",
      description: "3+ years across development & testing",
    },
    {
      icon: <GraduationCap className="h-5 w-5 text-teal-400" />,
      title: "Education",
      description: "B.Tech CSE · GPA 7.8",
    },
    {
          ...
          <div className="relative w-full aspect-square max-w-md mx-auto">
            ...
            <div className="relative h-full w-full overflow-hidden rounded-2xl">
              <Image
                ...
                alt="Venkata Yasaswini Godavarthi"
                width={400}
                height={400}
        ...
        >
          <div className="bg-gray-900/50 backdrop-blur-sm p-6 rounded-2xl border border-gray-800/50 shadow-lg">
            <p className="text-gray-300 leading-relaxed">
              Dynamic Software Engineer with 3+ years of professional experience, with 2+ years in the U.S. healthcare domain, specializing in .NET
              Full Stack development. Skilled in building scalable, high-impact applications throughout the full
              software lifecycle.
            </p>
            <p className="text-gray-300 leading-relaxed mt-4">
              Experienced in leveraging AI-driven tools to streamline workflows and enhance team productivity. Committed
              to delivering seamless, user-centric solutions through collaborative innovation.
            </p>
          </div>
